...
export type Booking = {
    ...
    createdByStaff?: { _id: string; fullName: string; email: string; phone?: string } | null,
    status: string,
    printStatus?: "not_printed" | "printed",
    printedAt?: string | null,
    printedBy?: { _id: string; fullName: string; email: string } | null,
    comboStatus?: string,
    comboClaimedAt?: string | null,
    comboClaimedBy?: { _id: string; fullName: string; email: string } | null,
    comboPrintStatus?: "not_printed" | "printed",
    comboPrintedAt?: string | null,
    comboPrintedBy?: { _id: string; fullName: string; email: string } | null,
