        ...
        >
          <Form form={antdForm} layout="vertical" initialValues={emptyFormValues} onFinish={handleSubmit}>
            ...
            <Row gutter={16}>
              ...
              <Col xs={24} sm={12} md={8}>
                <Form.Item name="minOrderAmount" label="Đơn tối thiểu (VND)" rules={[{ required: true, message: 'Vui lòng nhập giá trị đơn hàng tối thiểu' }]}> 
                  <InputNumber min={0} style={{ width: '100%' }} addonAfter="VND" />
                </Form.Item>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col xs={24} sm={12} md={8}>
                <Form.Item name="usageLimit" label="Giới hạn lượt dùng" rules={[{ required: true, message: 'Vui lòng nhập giới hạn số lần sử dụng' }]}> 
                ...
                > 
                  <DatePicker
                    ...
                    disabledDate={(current) => {
                      const startDate = antdForm.getFieldValue('startDate');
